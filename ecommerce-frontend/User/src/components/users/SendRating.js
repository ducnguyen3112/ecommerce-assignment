...
const SendRating = (props) => {
    ...
    return (
        <div className="card rating-card ">
            <div className="row">
                <div className="col-1">
                    <img src={userInfo.data.image} width="50" className="rounded-circle mt-1"/>
                </div>
                <div className="col-11">
                    <div className="comment-box ml-2">
                        ...
                        <div className="comment-area">
                            <textarea onChange={(e)=>comment = e.target.value} className="form-control" placeholder="what is your view?" rows="2"></textarea>
                        </div>
                        <div className="comment-btn mt-2">
                            <div >
                                <div >
                                    <div >
                                        <button onClick={() => handleSendClick()} className= {`${disabled===true ? "disabled btn btn-success send btn-sm":" btn btn-success send btn-sm" }`}>Send <i
