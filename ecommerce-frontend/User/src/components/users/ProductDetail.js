...
function ProductDetail() {
    ...
    const {productDetailLoading, productDetailError, productDetail} = productDetailSelector;
    ...
    return (
        <div className={'container container-comment'}>
                    ...
                    <div className="row gx-4 gx-lg-5 align-items-center">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="fs-5 mb-5">
                                <br/>
                                <NumberFormat value={productDetail.price} displayType={'text'} thousandSeparator={true} prefix={'VND '}/>
                            </div>
            ...
            <SendRating productId={id} listRating = {listRating} setListRating={setListRating}/>
            <RatingList productId={id} listRating = {listRating} setListRating={setListRating}/>
        </div>
